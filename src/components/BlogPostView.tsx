...
export default function BlogPostView({ slug, onNavigate }: BlogPostViewProps) {
  ...
  const serviceLinks = [
    ...
    { title: 'Emergency Repair Service', path: 'emergency-garage-door-repair', desc: '24/7 immediate dispatch in Appleton & Fox Valley' },
  ];
        ...
        <main className="w-full flex flex-col gap-8">
          ...
          <div className="bg-slate-900 text-white rounded-3xl p-6 md:p-8 border border-slate-800">
            <div className="flex items-center gap-2 text-amber-400 font-bold text-xs uppercase tracking-wider mb-2">
              ...
              Related Garage Services in Appleton, WI
            </div>
          ...
          <div className="bg-blue-900 text-white rounded-3xl p-8 flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl">
            <div>
              ...
              <p className="text-blue-200 text-xs md:text-sm mt-1">
                Call our licensed Appleton repair technicians directly at (920) 454-9949.
              </p>
            </div>
            <a
              href="tel:9204549949"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            ...
            <div className="bg-slate-900 text-white rounded-3xl p-6 border border-slate-800 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-lg font-black text-white">Appleton Garage Door</h3>
                <p className="text-slate-300 text-xs mt-2 leading-relaxed">
                  Serving Appleton, Grand Chute, Neenah, Menasha, Kaukauna, and surrounding Fox Valley communities with 24/7 same-day service.
                </p>
