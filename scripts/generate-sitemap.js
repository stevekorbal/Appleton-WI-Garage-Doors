...
function getDomainFromEnv() {
  ...
  if (!domain) {
    domain = (process.env.APP_URL && process.env.APP_URL !== 'MY_APP_URL')
      ? process.env.APP_URL
      : 'https://www.garagedoorrepairappletonwi.com';
  }
...
const staticPages = [
  ...
  { loc: '/city/appleton-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/grand-chute-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/kimberly-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/little-chute-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/combined-locks-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/kaukauna-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/greenville-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/neenah-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/menasha-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/freedom-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/hortonville-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/sherwood-wi', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/fox-crossing-wi', changefreq: 'weekly', priority: '0.8' },
